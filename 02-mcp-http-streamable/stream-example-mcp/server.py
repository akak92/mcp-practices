...
mcp = FastMCP("Streamable MCP Server", "An MCP server with streamable HTTP transport example.", port=8777)
...
if __name__ == "__main__":
    ...
    if "mcp" in sys.argv:
        ...
        uvicorn.run("server:app", host="127.0.0.1", port=8777, reload=True)